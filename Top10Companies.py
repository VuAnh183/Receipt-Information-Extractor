...
top_10_companies = [c[0] for c in company_counts.most_common(10)]
print("Top 10 Companies:", top_10_companies)

# Step 3: Copy only files related to the top 10 companies
for filename in entity_files:
    ...
    with open(entity_path, "r", encoding="utf-8") as f:
        try:
            ...
            # If company is in the top 10, copy related files
            if company_name in top_10_companies:
                # Copy entity file
